...
function CardSkeleton() {
    return (
      <div className="w-[249] h-[400px] border border-gray-300 rounded-lg overflow-hidden">
        ...
        <div className="w-[249px] h-[150px] bg-white opacity-50 rounded-sm animate-pulse px-4 py-3">
