                    ...
                    (
                        <>
                            <div className="w-full h-full flex flex-col items-center">
                                ...
                                <section>
                                    <form action="" className="w-full max-w-4xl h-[calc(100vh-150px)] sm:h-[calc(100vh-600px)] lg:h-[calc(100vh-800px)] xl:h-[18rem] 2xl:h-[22rem] flex flex-wrap justify-center items-center gap-3 md:gap-10 md:text-lg  rounded-lg p-5">
